...
/**
 * Activity for displaying and starting the registration example on Android
 * phone.
 * 
...
public class TutorialRegistrationActivity extends TutorialHelloWorldActivity {
	...
	private class TutorialLaunchingThread extends Thread {
		...
		public void run() {
			super.run();
			try {
				tutorial.launchTutorial(sipAddressWidget.getText().toString(), sipPasswordWidget.getText().toString());
