 ...
 * 
 */
public final class LinphoneService extends Service implements LinphoneCallStateListener, LinphoneGlobalStateListener, LinphoneRegistrationStateListener {
	/*
	...
	public void onCallEncryptionChanged(final LinphoneCall call, final boolean encrypted, final String authenticationToken) {
	}
}
